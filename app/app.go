...
import (
	...
	validatorvesting "github.com/ncp-labs/ncp/x/validator-vesting"
...
const (
	appName          = "ncp"
	Bech32MainPrefix = "ncp"
)

var (
	// default home directories for expected binaries
	DefaultCLIHome  = os.ExpandEnv("$HOME/.ncpcli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.ncpd")
