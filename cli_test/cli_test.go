...
func TestGaiaCLIKeysAddRecover(t *testing.T) {
	...
	require.Equal(t, "ncp1qcfdf69js922qrdr4yaww3ax7gjml6pd39p8lj", f.KeyAddress("test-recover").String())
...
func TestGaiaCLIKeysAddRecoverHDPath(t *testing.T) {
	...
	require.Equal(t, "ncp1qcfdf69js922qrdr4yaww3ax7gjml6pd39p8lj", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "ncp1pdfav2cjhry9k79nu6r8kgknnjtq6a7rcr0qlr", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "ncp1909k354n6wl8ujzu6kmh49w4d02ax7qvrrcgx5", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "ncp1v9plmhvyhgxk3th9ydacm7j4z357s3nhhmy0tv", f.KeyAddress("test-recoverH4").String())
